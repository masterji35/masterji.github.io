...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["editors-editors-module"], {
  ...
  /***/
  function node_modulesCkeditorCkeditorJs(module, exports) {
    /*
    ...
    (function () {
      ...
      window.CKEDITOR && window.CKEDITOR.dom || (window.CKEDITOR || (window.CKEDITOR = function () {
        ...
        CKEDITOR.tools = {
          ...
          extend: function extend(a) {
            ...
            for (var h = 1; h < g; h++) {
              ...
              for (e in c) {
                if (!0 === d || null == a[e]) if (!b || e in b) a[e] = c[e];
              }
            }
          ...
          enableHtml5Elements: function enableHtml5Elements(a, g) {
            for (var d = "abbr article aside audio bdi canvas data datalist details figcaption figure footer header hgroup main mark meter nav output progress section summary time video".split(" "), b = d.length, h; b--;) {
              h = a.createElement(d[b]), g && a.appendChild(h);
            }
          },
          ...
          getCsrfToken: function getCsrfToken() {
            ...
            if (!a || 40 != a.length) {
              var a = [],
                  g = "";
              if (window.crypto && window.crypto.getRandomValues) a = new Uint8Array(40), window.crypto.getRandomValues(a);else for (var d = 0; 40 > d; d++) {
                a.push(Math.floor(256 * Math.random()));
              }

              for (d = 0; d < a.length; d++) {
                var b = "abcdefghijklmnopqrstuvwxyz0123456789".charAt(a[d] % 36),
        ...
        clone: function clone(a, f) {
          ...
          function c(b) {
            if (b.type == CKEDITOR.NODE_ELEMENT || b.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
              ...
              if (a) for (e = 0; e < b.getChildCount(); e++) {
                c(b.getChild(e));
              }
            }
          }
        ...
        getIndex: function getIndex(a) {
          ...
          do {
            a && c != this.$ && c.nodeType == CKEDITOR.NODE_TEXT && (m || b(c)) || (e++, m = c.nodeType == CKEDITOR.NODE_TEXT);
        ...
        getPrevious: function getPrevious(a) {
          ...
          do {
            b = (f = f.previousSibling) && 10 != f.nodeType && new CKEDITOR.dom.node(f);
          } while (b && a && !a(b));
        ...
        getNext: function getNext(a) {
          ...
          do {
            b = (f = f.nextSibling) && new CKEDITOR.dom.node(f);
          } while (b && a && !a(b));
        ...
        remove: function remove(a) {
          ...
          if (b) {
            if (a) for (; a = f.firstChild;) {
              b.insertBefore(f.removeChild(a), f);
            }
            b.removeChild(f);
          }
        ...
        for (var f in a) {
          CKEDITOR.dom.element.clearMarkers(a, a[f], 1);
        }
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
          ...
          breakParent: function breakParent(a, b) {
            ...
            if (CKEDITOR.env.ie && !CKEDITOR.env.edge) {
              for (c = new CKEDITOR.dom.element("div"); e = g.getFirst();) {
                e.$.style.backgroundColor && (e.$.style.backgroundColor = e.$.style.backgroundColor), c.append(e);
              }
          ...
          mergeSiblings: function () {
            function a(b, d, g) {
              if (d && d.type == CKEDITOR.NODE_ELEMENT) {
                ...
                if (b.isIdentical(d)) {
                  for (var e = g ? b.getLast() : b.getFirst(); c.length;) {
                    c.shift().move(b, !g);
                  }
          ...
          removeStyle: function removeStyle(a) {
            ...
            if (b.removeProperty || "border" != a && "margin" != a && "padding" != a) b.removeProperty ? b.removeProperty(a) : b.removeAttribute(CKEDITOR.tools.cssStyleToDomStyle(a)), this.$.style.cssText || this.removeAttribute("style");else {
              ...
              for (var b = [], e = 0; e < c.length; e++) {
                if (g) for (var f = 0; f < g.length; f++) {
                  b.push([a, c[e], g[f]].join("-"));
          ...
          getDocumentPosition: function getDocumentPosition(a) {
            ...
            if (document.documentElement.getBoundingClientRect && (CKEDITOR.env.ie ? 8 !== CKEDITOR.env.version : 1)) {
              ...
              for (; q && !q.equals(w);) {
                b -= q.$.scrollLeft, c -= q.$.scrollTop, q = q.getParent();
              }
          ...
          getChild: function () {
            ...
            return function (b) {
              var c = this.$;
              if (b.slice) for (b = b.slice(); 0 < b.length && c;) {
                c = a(c, b.shift());
              } else c = a(c, b);
          ...
          forEach: function forEach(a, b, c) {
            ...
            if (!1 !== g) {
              ...
              for (var e = 0; e < c.count(); e++) {
                g = c.getItem(e), g.type == CKEDITOR.NODE_ELEMENT ? g.forEach(a, b) : b && g.type != b || a(g);
              }
            }
          }
        });
        ...
        function f(a, b, c, d, e) {
          ...
          function l() {
            ...
            for (a = 0; a < c; a++) {
              if (b = J[a], g = D[a], !b.equals(g)) return a;
            }
          ...
          if (t && v.type == CKEDITOR.NODE_TEXT && (y.equals(v) || y.type === CKEDITOR.NODE_ELEMENT && y.getFirst().equals(v))) c.append(a.document.createText(v.substring(z, B)));else {
            ...
            for (O = Q; O <= R; O++) {
              if (c = D[O], ba = c.getPrevious(), c.equals(J[O])) b && (L = L.getChild(0));else {
        ...
        CKEDITOR.dom.range.prototype = {
            ...
            function a(b) {
              ...
              if (g.type == CKEDITOR.NODE_TEXT) {
                ...
                for (f = 0; (e = e.getPrevious()) && e.type == CKEDITOR.NODE_TEXT;) {
                  f += e.getText().replace(CKEDITOR.dom.selection.FILLING_CHAR_SEQUENCE, "").length;
                }
            ...
            switch (a) {
              ...
              case CKEDITOR.ENLARGE_ELEMENT:
                ...
                for (t = c(t); t || y;) {
                  ...
                  for (; y;) {
                    if (B = !1, y.type == CKEDITOR.NODE_COMMENT) y = y.getPrevious();else {
                      if (y.type == CKEDITOR.NODE_TEXT) H = y.getText(), d.test(H) && (y = null), B = /[\s\ufeff]$/.test(H);else if ((y.$.offsetWidth > (CKEDITOR.env.webkit ? 1 : 0) || b && y.is("br")) && !y.data("cke-bookmark")) if (z && CKEDITOR.dtd.$removeEmpty[y.getName()]) {
                        H = y.getText();
                        if (d.test(H)) y = null;else for (var G = y.$.getElementsByTagName("*"), E = 0, I; I = G[E++];) {
                  ...
                  for (; y;) {
                    ...
                    if (y.type == CKEDITOR.NODE_TEXT) H = y.getText(), f(y, 0) || (y = null), B = /^[\s\ufeff]/.test(H);else if (y.type == CKEDITOR.NODE_ELEMENT) {
                      if ((0 < y.$.offsetWidth || b && y.is("br")) && !y.data("cke-bookmark")) if (z && CKEDITOR.dtd.$removeEmpty[y.getName()]) {
                        H = y.getText();
                        if (d.test(H)) y = null;else for (G = y.$.getElementsByTagName("*"), E = 0; I = G[E++];) {
                          if (!CKEDITOR.dtd.$removeEmpty[I.nodeName.toLowerCase()]) {
                            y = null;
                            break;
                          }
          ...
          removeEmptyBlocksAtEnd: function () {
            ...
            return function (b) {
              for (var c = this.createBookmark(), d = this[b ? "endPath" : "startPath"](), e = d.block || d.blockLimit, f; e && !e.equals(d.root) && !e.getFirst(a(e));) {
                f = e.getParent(), this[b ? "setEndAt" : "setStartAt"](e, CKEDITOR.POSITION_AFTER_END), e.remove(1), e = f;
              }
          ...
          _find: function _find(a, b) {
            var c = this.getCommonAncestor(),
                ...
                h,
                m;
            if (c && c.find) for (l = c.find(a), f = 0; f < l.count(); f++) {
              if (c = l.getItem(f), b || !c.isReadOnly()) h = c.getPosition(d.startNode) & CKEDITOR.POSITION_FOLLOWING || d.startNode.equals(c), m = c.getPosition(d.endNode) & CKEDITOR.POSITION_PRECEDING + CKEDITOR.POSITION_IS_CONTAINED || d.endNode.equals(c), h && m && e.push(c);
            }
            return e;
          }
        };
        ...
        CKEDITOR.dom.range.mergeRanges = function (a) {
          return CKEDITOR.tools.array.reduce(a, function (a, b) {
            ...
            if (c) {
              ...
              for (g = d.next(); e(g) || b.endContainer.equals(g);) {
                g = d.next();
              }
        ...
        a.prototype = {
          ...
          _getNextSourceNode: function _getNextSourceNode(a, b, c) {
            ...
            for (a = a.getNextSourceNode(b, null, d); !m(a);) {
        ...
        function a(a, b, c, d, e) {
          ...
          for (g in b) {
            ...
            for (m in K) {
              ...
              for (n in D) {
                "!" == n.charAt(0) && (n = n.slice(1), v.push(n), y[n] = !0, H = !1);
              }
          ...
          for (d = a.length; c < d; ++c) {
            ...
            for (m in J) {
              ...
              for (D in t) {
                -1 < D.indexOf("*") ? y.push(new RegExp("^" + D.replace(/\*/g, ".*") + "$")) : y.push(D);
              }
            ...
            if (!0 === g.elements || null === g.elements) e[f ? "unshift" : "push"](g);else for (r in h = g.elements, delete g.elements, h) {
              if (b[r]) b[r][f ? "unshift" : "push"](g);else b[r] = [g];
            }
          }
        }
        ...
        function f(a, c, e, g) {
          if (!a.match || a.match(c)) if (g || d(a, c)) if (a.propertiesOnly || (e.valid = !0), e.allAttributes || (e.allAttributes = b(a.attributes, c.attributes, e.validAttributes)), e.allStyles || (e.allStyles = b(a.styles, c.styles, e.validStyles)), !e.allClasses) {
            ...
            if (a) {
              if (!0 === a) a = !0;else {
                for (var f = 0, h = c.length, l; f < h; ++f) {
                  l = c[f], g[l] || (g[l] = a(l));
                }
        ...
        function d(a, b) {
          ...
          var c, d, e, g;
          if (e = a.requiredClasses) for (g = b.classes, c = 0; c < e.length; ++c) {
        ...
        function g(a) {
          ...
          for (a = I(a); b = a.match(D);) {
            (c = b[2]) ? (d = n(c, "styles"), e = n(c, "attrs"), c = n(c, "classes")) : d = e = c = null, g["$" + f++] = {
              elements: b[1],
              classes: c,
              styles: d,
              attributes: e
        ...
        function u(a, b, d, e) {
          ...
          if (e.doCallbacks && a.elementCallbacks) {
            a: {
              ...
              for (var l = 0, m = h.length, k; l < m; ++l) {
                if (k = h[l](b)) {
                  h = k;
                  break a;
                }
          ...
          if (e.doFilter) {
            a: {
              ...
              if (a || h) {
                p(b);
                if (l) for (D = 0, v = l.length; D < v; ++D) {
                  if (!1 === c(l[D], b, t)) {
                    a = null;
                    break a;
                  }
                }
                if (m) for (D = 0, v = m.length; D < v; ++D) {
                  c(m[D], b, t);
                }
                if (a) for (D = 0, v = a.length; D < v; ++D) {
                  f(a[D], b, t, k);
                }
                if (h) for (D = 0, v = h.length; D < v; ++D) {
                  f(h[D], b, t, k);
                }
                a = t;
              } else a = null;
            ...
            if (!a.allAttributes) for (x in l) {
              v[x] || (E.test(x) ? x == (r = x.replace(/^data-cke-saved-/, "")) || v[r] || (delete l[x], D = !0) : (delete l[x], D = !0));
            }

            if (!a.allStyles || a.hadInvalidStyle) {
              for (x in H) {
                a.allStyles || J[x] ? z.push(x + ":" + H[x]) : D = !0;
              }
          ...
          if (G.$empty[d] || !a.children.length) "hr" == d && "br" == b ? a.replaceWith(r()) : (a.parent && c.push({
            ...
            if ("br" == b) a.previous && !A(a.previous) && (b = r(), b.insertBefore(a)), a.next && !A(a.next) && (b = r(), b.insertAfter(a)), a.replaceWithChildren();else {
              ...
              if (e) a.name = b, a.attributes = {}, c.push({
                ...
                for (var g = e.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || "body" == e.name, l, m, f = d.length; 0 < f;) {
                  h = d[--f], g && (h.type == CKEDITOR.NODE_TEXT || h.type == CKEDITOR.NODE_ELEMENT && G.$inline[h.name]) ? (l || (l = new CKEDITOR.htmlParser.element(b), l.insertAfter(a), c.push({
                    check: "parent-down",
                    el: l
        ...
        function v(a, b) {
          ...
          for (g in d) {
            if ("class" == g) for (c = d[g].split(/\s+/), h = a.classes.join("|"); l = c.pop();) {
        ...
        CKEDITOR.filter.prototype = {
          ...
          applyTo: function applyTo(a, b, c, d) {
            ...
            a.forEach(function (a) {
              if (a.type == CKEDITOR.NODE_ELEMENT) {
                ...
                a: {
                  ...
                  c = [];
                  var q, k, t;
                  if (f) for (k = 0; k < f.length; ++k) {
                    if ((t = d.match(f[k])) && t[0].length == d.length) {
                      c = !0;
                      break a;
                    }
                  }
            ...
            for (var y; c = g.pop();) {
              c.type == CKEDITOR.NODE_ELEMENT ? t(c, d, a) : c.remove();
            }

            for (; k = a.pop();) {
              if (c = k.el, c.parent) switch (y = G[c.parent.name] || G.span, k.check) {
                case "it":
          ...
          addContentForms: function addContentForms(a) {
            if (!this.disabled && a) {
              ...
              for (b = 0; b < a.length && !e; ++b) {
                c = a[b], ("string" == typeof c || c instanceof CKEDITOR.style) && this.check(c) && (e = c);
              }
            ...
            if (!this.disabled && a) {
              ...
              for (e = 0; e < a.length; ++e) {
                ...
                for (f = 0; f < b.length; ++f) {
                  h = b[f], "string" == typeof h ? (h = h.split(/\s*:\s*/), l = h[0], m = null, q = h[1]) : (l = h.check, m = h.left, q = h.right), g || (g = h, g = g.element ? g.element : l ? l.match(/^([a-z0-9]+)/i)[0] : g.left.getDefinition().element), m instanceof CKEDITOR.style && (m = B(m)), c.push({
                    check: l == g ? null : l,
                    left: m,
        ...
        L = CKEDITOR.filter.transformationsTools = {
          ...
          transform: function transform(a, b) {
            if ("string" == typeof b) a.name = b;else {
              ...
              for (g in e) {
                if ("class" == g) for (c = a.classes.join("|"), h = e[g].split(/\s+/); l = h.pop();) {
                  -1 == c.indexOf(l) && a.classes.push(l);
        ...
        load: function load(a, f, b) {
          ...
          CKEDITOR.scriptLoader.load(m, function (a, e) {
            ...
            for (var g = 0; g < a.length; g++) {
              for (var h = k[a[g]], l = 0; l < h.length; l++) {
                var m = h[l];
                d[m] = this.get(m);
                c[m] = 1;
              }
          ...
          var m = {},
            ...
            a.call(this, b, function (a) {
              ...
              for (d in a) {
                ...
                if (!f[d]) {
                  if (n.icons) for (var u = n.icons.split(","), C = u.length; C--;) {
                    CKEDITOR.skin.addIcon(u[C], n.path + "icons/" + (CKEDITOR.env.hidpi && n.hidpi ? "hidpi/" : "") + u[C] + ".png");
                  }
                  f[d] = 1;
                }

                if (p) for (p.split && (p = p.split(",")), n = 0; n < p.length; n++) {
                  m[p[n]] || b.push(p[n]);
                }
              }
              ...
              if (b.length) k.call(this, b);else {
                for (d in m) {
                  n = m[d], n.onLoad && !n.onLoad._called && (!1 === n.onLoad() && delete m[d], n.onLoad._called = 1);
                }
        ...
        function m(a, b, c) {
          if (b) {
            ...
            for (e in g) {
              d = g[e], (c || d.contextSensitive) && d.refresh(a, b);
            }
          }
        }
        ...
        CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
          ...
          extractSelectedHtml: function extractSelectedHtml(a, b) {
            ...
            for (g = 0; g < d.length; g++) {
              e.append(c.extractHtmlFromRange(d[g], b));
            }
          ...
          setKeystroke: function setKeystroke() {
            for (var a = this.keystrokeHandler.keystrokes, b = CKEDITOR.tools.isArray(arguments[0]) ? arguments[0] : [[].slice.call(arguments, 0)], c, d, e = b.length; e--;) {
              c = b[e], d = 0, CKEDITOR.tools.isArray(c) && (d = c[1], c = c[0]), d ? a[c] = d : delete a[c];
            }
          },
        ...
        CKEDITOR.htmlParser.fragment.fromHtml = function (m, k, d) {
          ...
          C.onTagClose = function (a) {
            ...
            for (var c = [], e = [], g = r; g != w && g.name != a;) {
              g._.isBlockLike || e.unshift(g), c.push(g), g = g.returnPoint || g.parent;
            }
          ...
          forEach: function forEach(a, b, c) {
            ...
            if (!1 !== e) {
              ...
              for (var f = 0; f < c.length; f++) {
                e = c[f], e.type == CKEDITOR.NODE_ELEMENT ? e.forEach(a, b) : b && e.type != b || a(e);
              }
            }
          },
          getFilterContext: function getFilterContext(a) {
        ...
        function f(b, c, e, f) {
          ...
          for (k in c) {
            (d = b[k]) || (d = b[k] = new a()), d.add(c[k], e, f);
          }
        }
        ...
        a.prototype = {
          ...
          addMany: function addMany(a, c, e) {
            for (var f = [this.findIndex(c), 0], k = 0, d = a.length; k < d; k++) {
              f.push({
                value: a[k],
                priority: c,
                options: e
          ...
          findIndex: function findIndex(a) {
            for (var c = this.rules, e = c.length - 1; 0 <= e && a < c[e].priority;) {
              e--;
            }
          ...
          exec: function exec(a, c) {
            ...
            for (n = 0; n < d; n++) {
              if (e && (h = c.type, l = c.name), g = k[n], !(a.nonEditable && !g.options.applyToAll || a.nestedEditable && g.options.excludeNestedEditable)) {
          ...
          execOnName: function execOnName(a, c) {
            for (var e = 0, f = this.rules, k = f.length, d; c && e < k; e++) {
              d = f[e], a.nonEditable && !d.options.applyToAll || a.nestedEditable && d.options.excludeNestedEditable || (c = c.replace(d.value[0], d.value[1]));
            }
        ...
        function a(a, d) {
            ...
            return function (e) {
              if (e.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                var f = [],
                    ...
                    k,
                    t;
                if (l) for (h(l, 1) && f.push(l); l;) {
                  m(l) && (k = c(l)) && h(k) && ((t = c(k)) && !m(t) ? f.push(k) : (g(D).insertAfter(k), k.remove())), l = l.previous;
                }
          ...
          for (n in J) {
            l.elements[n] = f(D, a.config.fillEmptyBlocks);
          }
        ...
        CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node(), {
          ...
          split: function split(a) {
            for (var b = this.children.splice(a, this.children.length - a), f = this.clone(), k = 0; k < b.length; ++k) {
              b[k].parent = f;
            }
        ...
        CKEDITOR.inlineAll = function () {
          ...
          for (b in CKEDITOR.dtd.$editable) {
            for (var c = CKEDITOR.document.getElementsByTag(b), e = 0, m = c.count(); e < m; e++) {
              a = c.getItem(e), "true" == a.getAttribute("contenteditable") && (f = {
                element: a,
                config: {}
          ...
          proto: {
            ...
            insertElementIntoRange: function insertElementIntoRange(a, b) {
              ...
              if (g) for (; (f = b.getCommonAncestor(0, 1)) && (h = CKEDITOR.dtd[f.getName()]) && (!h || !h[e]);) {
                f.getName() in CKEDITOR.dtd.span ? b.splitElement(f) : b.checkStartOfBlock() && b.checkEndOfBlock() ? (b.setStartBefore(f), b.collapse(!0), f.remove()) : b.splitBlock(d == CKEDITOR.ENTER_DIV ? "div" : "p", c.editable());
              }
              b.insertNode(a);
              return !0;
            },
        ...
        w = function () {
          ...
          function b(c, d) {
            ...
            for (var k = m[k.getName()], n = 0, q = c.getChildren(), H = q.count(), x = -1, v = -1, r = 0, p = e.contains(m.$list); n < H; ++n) {
              e = q.getItem(n), a(e) ? (f = e.getName(), p && f in CKEDITOR.dtd.$list ? l = l.concat(b(e, d)) : (h = !!k[f], "br" != f || !e.data("cke-eol") || n && n != H - 1 || (r = (g = n ? l[n - 1].node : q.getItem(n + 1)) && (!a(g) || !g.is("br")), g = g && a(g) && m.$block[g.getName()]), -1 != x || h || (x = n), h || (v = n), l.push({
                isElement: 1,
                isLineBreak: r,
          ...
          function e(b, c) {
            ...
            for (n && d.push(" "); l < f; l++) {
              h = g.getItem(l), a(h) && !h.is(k) ? d = d.concat(e(h, c)) : d.push(h);
            }
          ...
          return function (n, D, r, p) {
            ...
            if (!p.checkReadOnly()) {
              ...
              for (; (u = g(D)) && a(u) && u.isBlockBoundary() && w.contains(u);) {
                D.moveToPosition(u, CKEDITOR.POSITION_BEFORE_END);
              }
              ...
              for (A = I.startNode; (A = A.getParent()) && f(A);) {
                p.push(A);
              }
              ...
              if (I = r) {
                ...
                if ("text" == n.type && n.inlineStylesRoot) {
                  ...
                  for (p = n.inlineStylesRoot.getParent(); !u.equals(p);) {
                    D = D.appendTo(u.clone()), u = u.getParent();
                  }
                ...
                if ((O = I.startPath().block) && (1 != O.getChildCount() || !O.getBogus())) a: {
                  ...
                  if (1 == u.getChildCount() && a(P = u.getFirst()) && P.is(q) && !P.hasAttribute("contenteditable")) {
                    ...
                    for (p = O.count(); I < p; I++) {
                      if (D = O.getItem(I), !D.is(x)) break a;
                    }
                  ...
                  if (M) r = 0 < p;else {
                    ...
                    if (A && C.isElement) {
                      ...
                      if (M) V && (Y = P.splitElement(V), n.zombies.push(Y), n.zombies.push(V));else {
                        ...
                        for (var W = [], aa = V.length, da = 0, ia = void 0, ja = 0, ea = -1; da < aa; da++) {
                          ia = V[da], " " == ia ? (ja || Z && !da || (W.push(new CKEDITOR.dom.text(" ")), ea = W.length), ja = 1) : (W.push(ia), ja = 0);
                        }
              ...
              for (Z = T.createBookmark(); S = n.zombies.pop();) {
                S.getParent() && (X = T.clone(), X.moveToElementEditStart(S), X.removeEmptyBlocksAtEnd());
              }

              if (Y) for (; S = Y.pop();) {
                CKEDITOR.env.needsBrFiller ? S.appendBogus() : S.append(T.document.createText(" "));
              }

              for (; S = n.mergeCandidates.pop();) {
                S.mergeSiblings();
              }
              ...
              return {
                ...
                deleteRanges: function deleteRanges(a) {
                  for (var b; b = a.tableContentsRanges.pop();) {
                    b.extractContents(), p(b.startContainer) && b.startContainer.appendBogus();
                  }
        ...
        function f(a) {
          ...
          for (e = 0; e < a.length; e++) {
            d = a[e]._getTableElement(), d.is && d.is({
              td: 1,
              th: 1
        ...
        CKEDITOR.dom.selection.prototype = {
          ...
          getRanges: function () {
            var a = w ? function () {
              ...
              var b = function b(_b2, c) {
                ...
                for (var e = d.children, g, f, h = _b2.duplicate(), l = 0, k = e.length - 1, m = -1, n, q; l <= k;) {
                  if (m = Math.floor((l + k) / 2), g = e[m], h.moveToElementText(g), n = h.compareEndPoints("StartToStart", _b2), 0 < n) k = m - 1;else if (0 > n) l = m + 1;else return {
                    container: d,
                    offset: a(g)
                  };
                }
                ...
                if (-1 == m || m == e.length - 1 && 0 > n) {
                  ...
                  for (d = e.length; 0 < h && 0 < d;) {
                    f = e[--d], f.nodeType == CKEDITOR.NODE_TEXT && (q = f, h -= f.nodeValue.length);
                  }
              ...
              case CKEDITOR.SELECTION_TEXT:
                ...
                if (c) {
                  if (c.collapsed) b = c.startContainer, b.type != CKEDITOR.NODE_ELEMENT && (b = b.getParent());else {
                    ...
                    if ((b = b.getChild(c.startOffset)) && b.type == CKEDITOR.NODE_ELEMENT) for (c = b.getFirst(); c && c.type == CKEDITOR.NODE_ELEMENT;) {
                      b = c, c = c.getFirst();
          ...
          selectRanges: function selectRanges(b) {
            ...
            this.reset();
            if (e) for (var e = this.root, f, k = 0; k < b.length; ++k) {
              f = b[k], f.endContainer.equals(e) && (f.endOffset = Math.min(f.endOffset, e.getChildCount()));
            }
            ...
            for (v.getPosition(p) == CKEDITOR.POSITION_FOLLOWING && (v = 0); v;) {
                ...
                if (z) {
                  if (B = v.getParent(), z = h, H = g, da = l, !B || !(B.getDtd() || CKEDITOR.dtd.span)[H] && !da || z.parentRule && !z.parentRule(B)) k = !0;else {
                    if (y || A && CKEDITOR.dtd.$removeEmpty[A] && (v.getPosition(p) | K) != K || (y = c.clone(), y.setStartBefore(v)), A = v.type, A == CKEDITOR.NODE_TEXT || t || A == CKEDITOR.NODE_ELEMENT && !v.getChildCount()) {
                      for (var A = v, F; (k = !A.getNext(I)) && (F = A.getParent(), n[F.getName()]) && f(F, r, h, J);) {
                        A = F;
                      }
              ...
              if (k && y && !y.collapsed) {
                for (var k = x(this, d), t = k.hasAttributes(), w = y.getCommonAncestor(), A = {}, z = {}, B = {}, H = {}, ea, E, ha; k && w;) {
                  if (w.getName() == g) {
                    for (ea in h.attributes) {
                      !H[ea] && (ha = w.getAttribute(E)) && (k.getAttribute(ea) == ha ? z[ea] = 1 : H[ea] = 1);
                    }

                    for (E in h.styles) {
                      !B[E] && (ha = w.getStyle(E)) && (k.getStyle(E) == ha ? A[E] = 1 : B[E] = 1);
                    }
                  }
        ...
        function c(a) {
          ...
          if (a.collapsed) {
            for (var g = new CKEDITOR.dom.elementPath(d.getParent(), a.root), f, h = 0, l; h < g.elements.length && (l = g.elements[h]) && l != g.block && l != g.blockLimit; h++) {
            ...
            for (g = d; !g.equals(m);) {
              f = g.getNextSourceNode(), g.type == CKEDITOR.NODE_ELEMENT && this.checkElementRemovable(g) && (g.getName() == this.element ? u.call(this, g) : w(g, t(this)[g.getName()]), f.type == CKEDITOR.NODE_ELEMENT && f.contains(d) && (b(), f = d.getNext())), g = f;
            }
          }
        ...
        function d(a) {
          ...
          for (var d, e = a.document, g; d = c.getNextParagraph();) {
            !d.isReadOnly() && (c.activeFilter ? c.activeFilter.check(this) : 1) && (g = x(this, e, d), l(d, g));
          }
        ...
        function h(a) {
          ...
          for (var d, e; d = c.getNextParagraph();) {
            this.checkElementRemovable(d) && (d.is("pre") ? ((e = this._.enterMode == CKEDITOR.ENTER_BR ? null : a.document.createElement(this._.enterMode == CKEDITOR.ENTER_P ? "p" : "div")) && d.copyAttributes(e), l(d, e)) : u.call(this, d));
          }
        ...
        function u(a, b) {
          ...
          for (f in d) {
            if ("class" != f && !this._.definition.fullMatch || a.getAttribute(f) == y(f, d[f])) b && "data-" == f.slice(0, 5) || (g = a.hasAttribute(f), a.removeAttribute(f));
          }

          for (var h in c) {
            this._.definition.fullMatch && a.getStyle(h) != y(h, c[h], !0) || (g = g || !!a.getStyle(h), a.removeStyle(h));
          }
        ...
        function C(a) {
          for (var b = t(this), c = a.getElementsByTag(this.element), d, e = c.count(); 0 <= --e;) {
            d = c.getItem(e), d.isReadOnly() || u.call(this, d, !0);
          }

          for (var g in b) {
            if (g != this.element) for (c = a.getElementsByTag(g), e = c.count() - 1; 0 <= e; e--) {
              d = c.getItem(e), d.isReadOnly() || w(d, b[g]);
            }
          }
        }
        ...
        function z(a, b, c) {
          ...
          var g, f;
          if (a.isFake && a.isInTable()) for (g = [], f = 0; f < e.length; f++) {
            g.push(e[f].clone());
          }

          for (var h = e.createIterator(); f = h.getNextRange();) {
            b.call(this, f, c);
          }
        ...
        CKEDITOR.style.prototype = {
          ...
          checkElementMatch: function checkElementMatch(a, b) {
            ...
            if ("string" == typeof this.element ? d == this.element : d in this.element) {
              ...
              if (c._length) {
                for (var h in c) {
                  if ("_length" != h) if (d = a.getAttribute(h) || "", "style" == h ? v(c[h], d) : c[h] == d) {
                    if (!b) return !0;
                  } else if (b) return !1;
                }
        ...
        for (b in CKEDITOR.dtd.$block) {
          b in CKEDITOR.dtd.$blockLimit || b in CKEDITOR.dtd.$empty || (f[b] = 1);
        }
        ...
        var f = {
          createIterator: function createIterator() {
            ...
            return {
              getNextRange: function getNextRange(k) {
                ...
                if (d && 1 < a.length) {
                  if (!f) for (var h = a.length - 1; 0 <= h; h--) {
                    e.unshift(a[h].createBookmark(!0));
                  }
                  ...
                  for (d.moveToBookmark(e.shift()); l--;) {
                    h = a[++f], h.moveToBookmark(e.shift()), d.setEnd(h.endContainer, h.endOffset);
                  }
                }
          ...
          createBookmarks: function createBookmarks(b) {
            for (var c = [], e, f = 0; f < this.length; f++) {
              ...
              for (var k = f + 1; k < this.length; k++) {
                this[k] = a(e, this[k]), this[k] = a(e, this[k], !0);
              }
            }
        ...
        function e(a, b, c) {
          var d, e, f;
          if (CKEDITOR.env.webkit) for (b = b.split("}").slice(0, -1), e = 0; e < b.length; e++) {
            b[e] = b[e].split("{");
          }
        ...
        if (a = CKEDITOR._.pending) for (delete CKEDITOR._.pending, f = 0; f < a.length; f++) {
          CKEDITOR.editor.prototype.constructor.apply(a[f][0], a[f][1]), CKEDITOR.add(a[f][0]);
        }
        ...
        onLoad: function onLoad() {
          var a = function a(_a7) {
            ...
            onChange: function onChange(a, b) {
              ...
              k = function k(a) {
            for (var b in a) {
              (m.test(b) || "title" == b || "type" == b) && delete a[b];
            }
            ...
            select: function select(b, c, d) {
              if (!(3 > arguments.length)) {
                ...
                CKEDITOR.ui.dialog.labeledElement.call(this, b, c, d, function () {
                  ...
                  for (var m = 0, x; m < c.items.length && (x = c.items[m]); m++) {
                    f.push('\x3coption value\x3d"', CKEDITOR.tools.htmlEncode(void 0 !== x[1] ? x[1] : x[0]).replace(/"/g, "\x26quot;"), '" /\x3e ', CKEDITOR.tools.htmlEncode(x[0]));
                  }
          ...
          CKEDITOR.ui.dialog.radio.prototype = CKEDITOR.tools.extend(new CKEDITOR.ui.dialog.uiElement(), {
            setValue: function setValue(a, b) {
              for (var c = this._.children, d, e = 0; e < c.length && (d = c[e]); e++) {
        ...
        CKEDITOR.dialog = function (b, d) {
          ...
          if (b._.removeDialogTabs && (p = b._.removeDialogTabs[d])) for (A = 0; A < p.length; A++) {
            r.removeContents(p[A]);
          }
          ...
          for (A = 0; A < r.contents.length; A++) {
            (p = r.contents[A]) && this.addPage(p);
          }
        ...
        CKEDITOR.dialog.prototype = {
          ...
          hide: function hide() {
            if (this.parts.dialog.isVisible()) {
              ...
              for (I(this); CKEDITOR.dialog._.currentTop != this;) {
          ...
          addPage: function addPage(a) {
            if (!a.requiredContent || this._.editor.filter.check(a.requiredContent)) {
              ...
              }, b), e = this._.contents[a.id] = {}, f = d.getChild(), g = 0; d = f.shift();) {
                d.notAllowed || "hbox" == d.type || "vbox" == d.type || g++, e[d.id] = d, "function" == typeof d.getChild && f.push.apply(f, d.getChild());
              }
        ...
        var q = {
          ...
          for (var d = 0, e; e = a[d]; d++) {
            if (e.id == b || c && e[c] && (e = x(e[c], b, c))) return e;
          }
          ...
          CKEDITOR.ui.dialog = {
            uiElement: function uiElement(a, b, c, d, e, f, g) {
              if (!(4 > arguments.length)) {
                ...
                for (var x = m["class"] && m["class"].split ? m["class"].split(" ") : [], q = 0; q < x.length; q++) {
                  x[q] && (r[x[q]] = 1);
                }
                ...
                for (q in m) {
                  k.push(q + '\x3d"' + CKEDITOR.tools.htmlEncode(m[q]) + '" ');
                }
            ...
            functions: function functions() {
              ...
              return function () {
                ...
                for (f = 0; f < e.length; f++) {
                  g = d == CKEDITOR.VALIDATE_AND ? g && e[f](b) : g || e[f](b);
                }
            ...
            if (e) {
              ...
              if (CKEDITOR.env.ie) {
                var k = m[0].startNode,
                    d = m[0].endNode,
                    h;
                if (k && "blockquote" == k.getParent().getName()) for (h = k; h = h.getNext();) {
                  if (h.type == CKEDITOR.NODE_ELEMENT && h.isBlockBoundary()) {
                    k.move(h, !0);
                    break;
                  }
                }
                if (d && "blockquote" == d.getParent().getName()) for (h = d; h = h.getPrevious();) {
                  if (h.type == CKEDITOR.NODE_ELEMENT && h.isBlockBoundary()) {
                    d.move(h);
                    break;
                  }
              ...
              if (b == CKEDITOR.TRISTATE_OFF) {
                ...
                for (d = 0; d < k.length; d++) {
                  b = k[d], h = h.getCommonAncestor(b.getParent());
                }
                ...
                for (d = null; 0 < k.length;) {
                  for (b = k.shift(); !b.getParent().equals(h);) {
                    b = b.getParent();
                  }
                ...
                for (; 0 < e.length;) {
                  if (b = e.shift(), "blockquote" == b.getName()) {
                    for (d = new CKEDITOR.dom.documentFragment(a.document); b.getFirst();) {
                      d.append(b.getFirst().remove()), k.push(d.getLast());
                    }
                ...
                for (e.insertBefore(k[0]); 0 < k.length;) {
                  b = k.shift(), e.append(b);
                }
                ...
                for (h = {}; 0 < d.length;) {
                  l = d.shift(), e = l.getParent(), l.getPrevious() ? l.getNext() ? (l.breakParent(l.getParent()), k.push(l.getNext())) : l.remove().insertAfter(e) : l.remove().insertBefore(e), e.getCustomData("blockquote_processed") || (k.push(e), CKEDITOR.dom.element.setMarker(h, e, "blockquote_processed", !0)), b.push(l);
                }
                ...
                if (a.config.enterMode == CKEDITOR.ENTER_BR) for (e = !0; b.length;) {
                  if (l = b.shift(), "div" == l.getName()) {
                    ...
                    for (e = l.getNext() && !(l.getNext().type == CKEDITOR.NODE_ELEMENT && l.getNext().isBlockBoundary()); l.getFirst();) {
                      l.getFirst().remove().appendTo(d);
                    }
        ...
        function a(a) {
          ...
          function c() {
            ...
            for (d in a.ui.items) {
              f = a.ui.items[d], g = f.toolbar || "others", g = g.split(","), f = g[0], g = parseInt(g[1] || -1, 10), b[f] || (b[f] = []), b[f].push({
                name: d,
                order: g
              });
            }
          ...
          function d(b, c) {
            if (c.length) {
              ...
              for (var d; d = c.shift();) {
                d = "string" == typeof d ? d : d.name, l && -1 != CKEDITOR.tools.indexOf(l, d) || (d = a.ui.create(d)) && a.addFeature(d) && b.items.push(d);
              }
            }
          }
          ...
          function h(a) {
            ...
            for (c = 0; c < a.length; ++c) {
              e = a[c], f = {}, "/" == e ? b.push(e) : CKEDITOR.tools.isArray(e) ? (d(f, CKEDITOR.tools.clone(e)), b.push(f)) : e.items && (d(f, CKEDITOR.tools.clone(e.items)), f.name = e.name, b.push(f));
            }
              ...
              switch (b) {
                ...
                case CKEDITOR.SHIFT + 9:
                  for (; !c || !c.items.length;) {
                    if (c = 9 == b ? (c ? c.next : a.toolbar.next) || e.toolbox.toolbars[0] : (c ? c.previous : a.toolbar.previous) || e.toolbox.toolbars[e.toolbox.toolbars.length - 1], c.items.length) for (a = c.items[f ? c.items.length - 1 : 0]; a && !a.focus;) {
                      (a = f ? a.previous : a.next) || (c = 0);
                    }
                  }
            ...
            e.on("destroy", function () {
              if (this.toolbox) {
                ...
                for (a = this.toolbox.toolbars; b < a.length; b++) {
                  for (e = a[b].items, c = 0; c < e.length; c++) {
                    f = e[c], f.clickFn && CKEDITOR.tools.removeFunction(f.clickFn), f.keyDownFn && CKEDITOR.tools.removeFunction(f.keyDownFn);
                  }
                }
              }
            });
          ...
          init: function init(a) {
            ...
            a.on("paste", function (a) {
              ...
              if (b.match(/^<[^<]+cke_(editable|contents)/i)) {
                ...
                for (f.setHtml(b); 1 == f.getChildCount() && (d = f.getFirst()) && d.type == CKEDITOR.NODE_ELEMENT && (d.hasClass("cke_editable") || d.hasClass("cke_contents"));) {
                  f = e = d;
                }
          ...
          cacheData: function cacheData() {
            ...
            if (this.$) {
              ...
              if (this.$ && this.$.files || d) {
                this._.files = [];
                if (this.$.files && this.$.files.length) for (c = 0; c < this.$.files.length; c++) {
        ...
        requires: "floatpanel",
        beforeInit: function beforeInit(a) {
          for (var f = a.config.menu_groups.split(","), b = a._.menuGroups = {}, c = a._.menuItems = {}, e = 0; e < f.length; e++) {
            b[f[e]] = e + 1;
          }
        ...
        function a(a, b) {
          ...
          a.on("selectionChange", function () {
            ...
            for (k = 0; k < d; k++) {
              t = f[k], m = a.lang.elementspath.eleTitle.replace(/%1/, t), t = c.output({
                id: n + k,
                label: m,
                text: t,
        ...
        function a(a, e) {
          ...
          e.on("refresh", function (a) {
            ...
            for (e in a.data.states) {
              c.push(a.data.states[e]);
            }
        ...
        CKEDITOR.plugins.add("indent", {
          init: function init(b) {
            ...
            b.on("dirChanged", function (a) {
              ...
              for (var f = new CKEDITOR.dom.walker(e), l; l = f.next();) {
                if (l.type == CKEDITOR.NODE_ELEMENT) if (!l.equals(d) && l.getDirection()) e.setStartAfter(l), f = new CKEDITOR.dom.walker(e);else {
                  var g = b.config.indentClasses;
                  if (g) for (var n = "ltr" == a.data.dir ? ["_rtl", ""] : ["", "_rtl"], p = 0; p < g.length; p++) {
                    l.hasClass(g[p] + n[0]) && (l.removeClass(g[p] + n[0]), l.addClass(g[p] + n[1]));
                  }
        ...
        function a(a) {
          function c(f) {
            for (var h = m.startContainer, r = m.endContainer; h && !h.getParent().equals(f);) {
              h = h.getParent();
            }

            for (; r && !r.getParent().equals(f);) {
              r = r.getParent();
            }
            ...
            for (var A = h, h = [], t = !1; !t;) {
              A.equals(r) && (t = !0), h.push(A), A = A.getNext();
            }
            ...
            for (r = 0; r < A.length; r++) {
              if (A[r].getName && k[A[r].getName()]) {
                f = A[r];
                break;
              }
            }

            for (var A = e.isIndent ? 1 : -1, r = h[0], h = h[h.length - 1], t = CKEDITOR.plugins.list.listToArray(f, g), y = t[h.getCustomData("listarray_index")].indent, r = r.getCustomData("listarray_index"); r <= h.getCustomData("listarray_index"); r++) {
              if (t[r].indent += A, 0 < A) {
                var v = t[r].parent;
            ...
            for (r = h.getCustomData("listarray_index") + 1; r < t.length && t[r].indent > y; r++) {
              t[r].indent += A;
            }
            ...
            if (!e.isIndent) {
              var z;
              if ((z = f.getParent()) && z.is("li")) for (var A = h.listNode.getChildren(), B = [], C, r = A.count() - 1; 0 <= r; r--) {
                (C = A.getItem(r)) && C.is && C.is("li") && B.push(C);
              }
            }

            h && h.listNode.replace(f);
            if (B && B.length) for (r = 0; r < B.length; r++) {
              for (C = f = B[r]; (C = C.getNext()) && C.is && C.getName() in k;) {
                CKEDITOR.env.needsNbspFiller && !f.getFirst(b) && f.append(m.document.createText(" ")), f.append(C);
              }
        ...
        function a(a, b, c) {
          ...
          for (g = 0; g < f.length; g++) {
            h = f[g].getCustomData("listarray_index"), e[h].indent = -1;
          }
        ...
        function b(a, b, c, d) {
          for (var e, f; e = a[d ? "getLast" : "getFirst"](u);) {
            (f = e.getDirection(1)) !== b.getDirection(1) && e.setAttribute("dir", f), e.remove(), c ? e[d ? "insertBefore" : "insertAfter"](c) : b.append(e, d);
          }
        }
          ...
          listToArray: function listToArray(a, b, c, e, f) {
            ...
            for (var g = 0, h = a.getChildCount(); g < h; g++) {
              ...
              if ("li" == k.$.nodeName.toLowerCase()) {
                ...
                for (var m = 0, n = k.getChildCount(), p; m < n; m++) {
                  p = k.getChild(m), p.type == CKEDITOR.NODE_ELEMENT && d[p.getName()] ? CKEDITOR.plugins.list.listToArray(p, b, c, e + 1, l.grandparent) : l.contents.push(p);
                }
              }
            }
          ...
          arrayToList: function arrayToList(a, b, c, e, f) {
            ...
            for (var h, k = a[c].parent.getDocument(), m = new CKEDITOR.dom.documentFragment(k), n = null, z = c, B = Math.max(a[c].indent, 0), p = null, u, E, I = e == CKEDITOR.ENTER_P ? "p" : "div";;) {
              ...
              if (F.indent == B) {
                ...
                for (h = 0; h < F.contents.length; h++) {
                  p.append(F.contents[h].clone(1, 1));
                }
                ...
                for (h = 0; h < R; h++) {
                  if (N = F.contents[h], l(N) && 1 < R) Q ? L = N.clone(1, 1) : p.append(N.clone(1, 1));else if (N.type == CKEDITOR.NODE_ELEMENT && N.isBlockBoundary()) {
            ...
            if (b) for (a = m.getFirst(); a;) {
              if (a.type == CKEDITOR.NODE_ELEMENT && (CKEDITOR.dom.element.clearMarkers(b, a), a.getName() in CKEDITOR.dtd.$listItem && (c = a, k = f = e = void 0, e = c.getDirection()))) {
                for (f = c.getParent(); f && !(k = f.getDirection());) {
                  f = f.getParent();
                }
        ...
        f.prototype = {
          exec: function exec(b) {
            ...
            for (var e = f.createBookmarks(!0), k = [], m = {}, h = h.createIterator(), n = 0; (l = h.getNextRange()) && ++n;) {
              ...
              for (l.forceBrBreak = this.state == CKEDITOR.TRISTATE_OFF; v = l.getNextParagraph();) {
                if (!v.getCustomData("list_block")) {
                  CKEDITOR.dom.element.setMarker(m, v, "list_block", 1);

                  for (var u = b.elementPath(v), z = u.elements, B = 0, u = u.blockLimit, G, E = z.length - 1; 0 <= E && (G = z[E]); E--) {
                    if (d[G.getName()] && u.contains(G)) {
            ...
            for (G = []; 0 < k.length;) {
              if (z = k.shift(), this.state == CKEDITOR.TRISTATE_OFF) {
                if (d[z.root.getName()]) {
                  ...
                  for (v = 0; v < n.contents.length; v++) {
                    E = n.contents[v], (E = E.getAscendant("li", !0)) && !E.getCustomData("list_item_processed") && (u.push(E), CKEDITOR.dom.element.setMarker(z, E, "list_item_processed", !0));
                  }
                  ...
                  for (v = 0; v < u && (B = z.listNode.getChild(v)); v++) {
                  ...
                  for (E = 0; E < u.length; E++) {
                    l = l.getCommonAncestor(u[E].getParent());
                  }
                  ...
                  if (!(1 > n.length)) {
                    ...
                    for (I = v = void 0; n.length;) {
                      v = n.shift(), I = h.createElement("li"), F = v, F.is("pre") || p.test(F.getName()) || "false" == F.getAttribute("contenteditable") ? v.appendTo(I) : (v.copyAttributes(I), z && v.getDirection() && (I.removeStyle("direction"), I.removeAttribute("dir")), v.moveChildren(I), v.remove()), I.appendTo(E);
                    }
              ...
              if (C && w) {
                if (x && (x.is("li") || x.getParent().is("li"))) {
                  ...
                  if (A.is("li")) p || t ? (p && t && m.remove(), x[t ? "insertAfter" : "insertBefore"](A)) : x.breakParent(A);else {
                    ...
                    } else if (x.appendBogus(!0), p || t) for (; u = x[p ? "getFirst" : "getLast"]();) {
                      u[p ? "insertBefore" : "insertAfter"](m);
                    } else for (x.breakParent(m); u = x.getLast();) {
                      u.insertAfter(m);
                    }
                    x.remove();
                  }
        ...
        function m(a, d, g, k) {
          if (k && k.length) for (var p, u = k.length; u--;) {
            if (p = k[u], "hbox" != p.type && "vbox" != p.type && "fieldset" != p.type || m(a, d, g, p.children), p.filebrowser) if ("string" == typeof p.filebrowser && (p.filebrowser = {
        ...
        CKEDITOR.on("dialogDefinition", function (a) {
          if (a.editor.plugins.filebrowser) for (var b = a.data.definition, c, d = 0; d < b.contents.length; ++d) {
            if (c = b.contents[d]) m(a.editor, a.data.name, b, c.elements), c.hidden && c.filebrowser && (c.hidden = !k(b, c.id, c.filebrowser));
          }
        });
      }(), function () {
        function a(a) {
          ...
          CKEDITOR.ui.listBlock = CKEDITOR.tools.createClass({
            ...
            proto: {
              ...
              showAll: function showAll() {
                ...
                for (var f in b) {
                  a = c.getById(b[f]), d = a.getNext(), a.setStyle("display", ""), d && "ul" == d.getName() && d.setStyle("display", "");
                }
              },
          ...
          if (!a.blockless) {
            ...
            0 !== m && a.ui.addRichCombo("Format", {
              ...
              onOpen: function onOpen() {
                ...
                for (var b in e) {
                  a.activeFilter.check(e[b]) || this.hideItem(b);
                }
              },
              refresh: function refresh() {
                ...
                if (b) {
                  if (b.isContextFor("p")) for (var c in e) {
        ...
        $: function $() {
          ...
          for (f in CKEDITOR.tools.extend({}, a.$nonBodyContent, a.$block, a.$listItem, a.$tableContent)) {
            this.setRules(f, {
              indent: !a[f]["#"],
              breakBeforeOpen: 1,
        ...
        function b(b, c) {
          ...
          for (var h = 0; h < e.length; h++) {
            d = e[h].toLowerCase(), f = c[d], 0 < h && g.push(","), g.push("'", f ? a(encodeURIComponent(c[d])) : "", "'");
          }
        ...
        CKEDITOR.plugins.link = {
          ...
          getEditorAnchors: function getEditorAnchors(a) {
            for (var b = a.editable(), c = b.isInline() && !a.plugins.divarea ? a.document : b, b = c.getElementsByTag("a"), c = c.getElementsByTag("img"), d = [], e = 0, f; f = b.getItem(e++);) {
              (f.data("cke-saved-name") || f.hasAttribute("name")) && d.push({
                name: f.data("cke-saved-name") || f.getAttribute("name"),
                id: f.getAttribute("id")
              });
            }

            for (e = 0; f = c.getItem(e++);) {
              (f = this.tryRestoreFakeAnchor(a, f)) && d.push({
          ...
          parseLinkAttributes: function parseLinkAttributes(a, b) {
            ...
            c.match(e) && ("encode" == t ? c = c.replace(n, function (a, b, c) {
              ...
              if (b == f.name) {
                ...
                for (var d = c.length, e, g, h = 0; h < d; h++) {
                  e = decodeURIComponent, g = c[h].replace(b, "").replace(/\\'/g, "'"), g = e(g), e = f.params[h].toLowerCase(), a[e] = g;
                }
        ...
        function d(a) {
          ...
          B(c, {
            ...
            place: function place() {
              ...
              for (var l in k) {
                k[l] = CKEDITOR.tools.cssLength(k[l]);
              }
        ...
        function A(a, b, c, d) {
          for (var e = b.getDocumentPosition(), f = {}, g = {}, h = {}, k = {}, l = aa.length; l--;) {
            f[aa[l]] = parseInt(b.getComputedStyle.call(b, "border-" + aa[l] + "-width"), 10) || 0, h[aa[l]] = parseInt(b.getComputedStyle.call(b, "padding-" + aa[l]), 10) || 0, g[aa[l]] = parseInt(b.getComputedStyle.call(b, "margin-" + aa[l]), 10) || 0;
          }
        ...
        var V = function () {
          ...
          function b(e) {
            ...
            if (g && f.contains(g)) for (; !g.getParent().equals(f);) {
              g = g.getParent();
            } else g = f.getFirst(function (a) {
              return d(e, a);
            });
            if (h && f.contains(h)) for (; !h.getParent().equals(f);) {
              h = h.getParent();
            ...
            for (var f = Number.MAX_VALUE, l, v, q, y; h && !h.equals(g) && (v = g.getNext(e.isRelevant));) {
              l = Math.abs(c(e, g, v) - e.mouse.y), l < f && (f = l, q = g, y = v), g = v, t(e, g);
            }
                ...
                exec: function exec() {
                  ...
                  if (this.state == CKEDITOR.TRISTATE_OFF) {
                    ...
                    for (q = a.container; q = q.getParent();) {
                      q.setCustomData("maximize_saved_styles", b(q)), q.setStyle("z-index", a.config.baseFloatZIndex - 5);
                    }
                    ...
                    for (var q = [w, C], r = 0; r < q.length; r++) {
                      c(q[r], q[r].getCustomData("maximize_saved_styles")), q[r].removeCustomData("maximize_saved_styles");
                    }

                    for (q = a.container; q = q.getParent();) {
                      c(q, q.getCustomData("maximize_saved_styles")), q.removeCustomData("maximize_saved_styles");
                    }
            ...
            exec: function exec(a) {
              for (var f = a._.removeFormatRegex || (a._.removeFormatRegex = new RegExp("^(?:" + a.config.removeFormatTags.replace(/,/g, "|") + ")$", "i")), b = a._.removeAttributes || (a._.removeAttributes = a.config.removeFormatAttributes.split(",")), c = CKEDITOR.plugins.removeformat.filter, e = a.getSelection().getRanges(), m = e.createIterator(), k = function k(a) {
                ...
                var h = d.createBookmark(),
                    ...
                    g = h.endNode,
                    n = function n(b) {
                  for (var d = a.elementPath(b), e = d.elements, g = 1, h; (h = e[g]) && !h.equals(d.block) && !h.equals(d.blockLimit); g++) {
                    f.test(h.getName()) && c(a, h) && b.breakParent(h);
                  }
                };

                n(l);
                if (g) for (n(g), l = l.getNextSourceNode(!0, CKEDITOR.NODE_ELEMENT); l && !l.equals(g);) {
                  if (l.isReadOnly()) {
        ...
        addMenuItems: function addMenuItems(a) {
          ...
          for (var c = a.config.scayt_contextMenuItemsOrder.split("|"), e = 0; e < c.length; e++) {
            c[e] = "scayt_" + c[e];
          }

          if ((c = ["grayt_description", "grayt_suggest", "grayt_control"].concat(c)) && c.length) for (e = 0; e < c.length; e++) {
            a.addMenuGroup(c[e], e - 10);
          }
            ...
            c.attachListener(c, "focus", function (c) {
              ...
              if ((b || c) && a._.savedSelection) {
                ...
                for (var k = 0; k < c.length; k++) {
                  f = c[k], "string" === typeof f.startContainer.$.nodeValue && (d = f.startContainer.getText().length, (d < f.startOffset || d < f.endOffset) && a.unlockSelection(!1));
                }
              }
            }, this, null, -10);
          },
        ...
        buildSuggestionMenuItems: function buildSuggestionMenuItems(a, f, b) {
          ...
          if (0 < f.length && "no_any_suggestions" !== f[0]) {
            if (b) for (b = 0; b < f.length; b++) {
              ...
              h = "grayt_suggest_" + CKEDITOR.plugins.scayt.suggestions[b].replace(" ", "_"), a.addCommand(h, this.createCommand(CKEDITOR.plugins.scayt.suggestions[b], m, k)), a.addMenuItem(h, {
                label: f[b],
                command: h,
                group: "grayt_suggest",
                order: b + 1
        ...
        replaceOldOptionsNames: function replaceOldOptionsNames(a) {
          for (var f in a) {
            f in this.backCompatibilityMap && (a[this.backCompatibilityMap[f]] = a[f], delete a[f]);
          }
        },
        ...
        CKEDITOR.plugins.add("stylescombo", {
          ...
          init: function init(a) {
            ...
            a.on("stylesSet", function (b) {
              if (b = b.data.styles) {
                for (var d, h, l, g = 0, n = b.length; g < n; g++) {
                  (d = b[g], a.blockless && d.element in CKEDITOR.dtd.$block || "string" == typeof d.type && !CKEDITOR.style.customHandlers[d.type] || (h = d.name, d = new CKEDITOR.style(d), a.filter.customConfig && !a.filter.check(d))) || (d._name = h, d._.enterMode = f.enterMode, d._.type = l = d.assignedTo || d.type, d._.weight = g + 1E3 * (l == CKEDITOR.STYLE_OBJECT ? 1 : l == CKEDITOR.STYLE_BLOCK ? 2 : 3), c[h] = d, e.push(d), m.push(d));
                }
            ...
            a.ui.addRichCombo("Styles", {
              ...
              init: function init() {
                ...
                for (m = e.length; g < m; g++) {
                  a = e[g], c = a._name, l = a._.type, l != f && (this.startGroup(b["panelTitle" + String(l)]), f = l), this.add(c, a.type == CKEDITOR.STYLE_OBJECT ? c : a.buildPreview(), c);
                }
              ...
              if (b.editable().hasFocus) {
                ...
                if (d = new CKEDITOR.dom.elementPath(c.getCommonAncestor(), c.root).contains({
                  ...
                  if (f || a) {
                    ...
                    for (var l = d.getAscendant("table").$, f = d.getParent().$.cells, l = new CKEDITOR.dom.element(l.insertRow(-1), b.document), g = 0, n = f.length; g < n; g++) {
                      l.append(new CKEDITOR.dom.element(f[g], b.document).clone(!1, !1)).appendBogus();
                    }
        ...
        CKEDITOR.plugins.add("tab", {
          init: function init(e) {
            for (var m = !1 !== e.config.enableTabKeyTools, k = e.config.tabSpaces || 0, d = ""; k--;) {
              d += " ";
            }
        ...
        function a(a, b) {
          ...
          for (var g = a.getRanges(), h = 0; h < g.length; h++) {
            ...
            if (k.collapsed) (k = k.getCommonAncestor().getAscendant({
              ...
              for (k.guard = d; l = k.next();) {
                l.type == CKEDITOR.NODE_ELEMENT && l.is(CKEDITOR.dtd.table) || (l = l.getAscendant({
                  td: 1,
                  th: 1
        ...
        function m(b, c) {
          for (var d = w(b) ? b : a(b), f = d[0].getAscendant("table"), g = e(d, 1), d = e(d), h = c ? g : d, k = CKEDITOR.tools.buildTableMap(f), f = [], g = [], d = [], l = k.length, m = 0; m < l; m++) {
            f.push(k[m][h]), g.push(c ? k[m][h - 1] : k[m][h + 1]);
          }

          for (m = 0; m < l; m++) {
            f[m] && (1 < f[m].colSpan && g[m] == f[m] ? (k = f[m], k.colSpan += 1) : (h = new CKEDITOR.dom.element(f[m]), k = h.clone(), k.removeAttribute("colSpan"), k.appendBogus(), k[c ? "insertBefore" : "insertAfter"].call(k, h), d.push(k), k = k.$), m += k.rowSpan - 1);
          }
        ...
        function k(b) {
          ...
          for (b = h.length; n < b; n++) {
            for (var p = 0, u = h[n].length; p < u; p++) {
              void 0 === k && h[n][p] == f.$ && (k = p), h[n][p] == g.$ && (l = p);
            }
          }

          for (n = k; n <= l; n++) {
            for (p = 0; p < h.length; p++) {
              g = h[p], f = new CKEDITOR.dom.element(e.$.rows[p]), g = new CKEDITOR.dom.element(g[n]), g.$ && (1 == g.$.colSpan ? g.remove() : --g.$.colSpan, p += g.$.rowSpan - 1, f.$.cells.length || m.push(f));
            }
          }
        ...
        function h(b) {
          if (b instanceof CKEDITOR.dom.selection) {
            ...
            a: {
              ...
              for (var k = {}, m, n; m = d[g++];) {
                CKEDITOR.dom.element.setMarker(k, m, "delete_cell", !0);
              }
        ...
        function n(b, c, d) {
          ...
          for (c = e - 1; 0 <= c; c--) {
            f = d.getItem(c), f.$.cells.length || (f.remove(), e++);
          }
        ...
        function p(b, c) {
          ...
          if (1 < m) {
            ...
            for (var m = Math.floor(m / 2), e = k + n, f = new CKEDITOR.dom.element(f.$.rows[e]), h = g(h, e), p, e = d.clone(), k = 0; k < h.length; k++) {
              if (p = h[k], p.parentNode == f.$ && k > l) {
            ...
            p || f.append(e);
          } else for (m = n = 1, f = e.clone(), f.insertAfter(e), f.append(e = d.clone()), p = g(h, k), l = 0; l < p.length; l++) {
            p[l].rowSpan++;
          }
        ...
        function a(a, b) {
          ...
          for (c = f; c <= g; c++) {
            for (f = m; f <= n; f++) {
              d = new CKEDITOR.dom.element(e[c][f]), d.$ && !d.getCustomData("selected_cell") && (k.push(d), CKEDITOR.dom.element.setMarker(l, d, "selected_cell", !0));
            }
          }
        ...
        function e(a, b) {
          ...
          for (e = 0; e < b.length; e++) {
            d = a.createRange(), d.setStartBefore(b[e]), d.setEndAfter(b[e]), c.push(d);
          }
        ...
        u.prototype.insertRow = function (a, b, c) {
          ...
          for (var d = this.cells.first.$.cellIndex, e = this.cells.last.$.cellIndex, f = c ? [] : this.cells.all, g, h = 0; h < a; h++) {
            g = A(c ? this.cells.all : f, b), g = CKEDITOR.tools.array.filter(g.find("td, th").toArray(), function (a) {
        ...
        u.prototype.insertColumn = function (a) {
          ...
          for (var c = this.cells, d = c.all, e = h(c.first), f = h(c.last), c = 0; c < a; c++) {
            d = d.concat(CKEDITOR.tools.array.filter(t(d), b));
          }
              ...
              function c(b, d) {
                ...
                if (k && k.is && k.is(e)) {
                  for (var l = k.getAscendant("table", !0), m = k.getPreviousSourceNode(!1, CKEDITOR.NODE_ELEMENT, l), n = !1, p = function p(a) {
                    ...
                    m = m.getPreviousSourceNode(!1, CKEDITOR.NODE_ELEMENT, l);
                  }
        ...
        b.prototype = {
          ...
          getNextImage: function getNextImage(a) {
            ...
            } else for (e = this.index + 1; e < b.length; e++) {
              if (a = b[e], !c.equalsContent(a)) return a.index = e, a;
            }
            return null;
          },
          ...
          update: function update(a) {
            if (!this.locked) {
              ...
              for (var b = this.index, e = this.snapshots; 0 < b && this.currentImage.equalsContent(e[b - 1]);) {
                --b;
              }
            ...
            g.attachListener(g, "keydown", function () {
              ...
              if (!c) {
                for (var e = 0; e < b.count(); e++) {
                  b.getItem(e).setCustomData("retain", !0);
                }
        ...
        var a = function a(_a13, b) {
          ...
          for (var e = 0; e < _a13.length; e++) {
            CKEDITOR.skin.icons[_a13[e]] = {
              path: c,
              offset: -_a13[++e],
              bgsize: _a13[++e]
            };
  ...
  /***/
  function node_modulesNg2CkeditorLibNg2CkeditorJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg2CkeditorLibSrcCkbuttonDirectiveJs(module, exports, __webpack_require__) {
    "use strict";
    ...
    function () {
      ...
      CKButtonDirective = __decorate([core_1.Directive({
        selector: 'ckbutton'
      })], CKButtonDirective);
      return CKButtonDirective;
    }();

    exports.CKButtonDirective = CKButtonDirective; //# sourceMappingURL=ckbutton.directive.js.map
  ...
  /***/
  function node_modulesNg2CkeditorLibSrcCkeditorComponentJs(module, exports, __webpack_require__) {
    "use strict";
    ...
    function () {
      ...
      CKEditorComponent = CKEditorComponent_1 = __decorate([core_1.Component({
        selector: 'ckeditor',
        providers: [{
      ...
      }), __metadata("design:paramtypes", [core_1.NgZone])], CKEditorComponent);
      return CKEditorComponent;
    }();

    exports.CKEditorComponent = CKEditorComponent; //# sourceMappingURL=ckeditor.component.js.map
  ...
  /***/
  function node_modulesNg2CkeditorLibSrcCkeditorModuleJs(module, exports, __webpack_require__) {
    "use strict";
    ...
    function () {
      ...
      CKEditorModule = __decorate([core_1.NgModule({
    ...
    exports.CKEditorModule = CKEditorModule; //# sourceMappingURL=ckeditor.module.js.map
  ...
  /***/
  function node_modulesNg2CkeditorLibSrcCkgroupDirectiveJs(module, exports, __webpack_require__) {
    "use strict";
    ...
    var CKGroupDirective =
    /** @class */
    function () {
      function CKGroupDirective() {}

      CKGroupDirective.prototype.ngAfterContentInit = function () {
        var _this = this; // Reconfigure each button's toolbar property within ckgroup to hold its parent's name
      ...
      __decorate([core_1.Input(), __metadata("design:type", String)], CKGroupDirective.prototype, "name", void 0);

      __decorate([core_1.Input(), __metadata("design:type", Object)], CKGroupDirective.prototype, "previous", void 0);

      __decorate([core_1.Input(), __metadata("design:type", String)], CKGroupDirective.prototype, "subgroupOf", void 0);

      __decorate([core_1.ContentChildren(ckbutton_directive_1.CKButtonDirective), __metadata("design:type", core_1.QueryList)], CKGroupDirective.prototype, "toolbarButtons", void 0);

      CKGroupDirective = __decorate([core_1.Directive({
        selector: 'ckgroup'
      })], CKGroupDirective);
      return CKGroupDirective;
    }();

    exports.CKGroupDirective = CKGroupDirective; //# sourceMappingURL=ckgroup.directive.js.map
  ...
  /***/
  function srcAppPagesEditorsCkeditorCkeditorComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _ckeditor_loader__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./ckeditor.loader */
    "./src/app/pages/editors/ckeditor/ckeditor.loader.ts");
    /* harmony import */


    var _ckeditor_loader__WEBPACK_IMPORTED_MODULE_2___default =
    /*#__PURE__*/
    __webpack_require__.n(_ckeditor_loader__WEBPACK_IMPORTED_MODULE_2__);
    /* harmony import */


    var ckeditor__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ckeditor */
    "./node_modules/ckeditor/ckeditor.js");
    /* harmony import */


    var ckeditor__WEBPACK_IMPORTED_MODULE_3___default =
    /*#__PURE__*/
    __webpack_require__.n(ckeditor__WEBPACK_IMPORTED_MODULE_3__);

    var CKEditorComponent = function CKEditorComponent() {
      _classCallCheck(this, CKEditorComponent);
    };

    CKEditorComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
  ...
  /***/
  function srcAppPagesEditorsCkeditorCkeditorLoaderTs(module, exports) {
  ...
  /***/
  function srcAppPagesEditorsEditorsRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "EditorsRoutingModule", function () {
    ...
    var _editors_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./editors.component */
    ...
    var _ckeditor_ckeditor_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./ckeditor/ckeditor.component */
    "./src/app/pages/editors/ckeditor/ckeditor.component.ts");

    var routes = [{
      path: '',
      component: _editors_component__WEBPACK_IMPORTED_MODULE_3__["EditorsComponent"],
      children: [{
        path: 'tinymce',
        component: _tiny_mce_tiny_mce_component__WEBPACK_IMPORTED_MODULE_4__["TinyMCEComponent"]
      }, {
        path: 'ckeditor',
        component: _ckeditor_ckeditor_component__WEBPACK_IMPORTED_MODULE_5__["CKEditorComponent"]
      }]
    }];

    var EditorsRoutingModule = function EditorsRoutingModule() {
      _classCallCheck(this, EditorsRoutingModule);
    };

    EditorsRoutingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"].forChild(routes)],
      exports: [_angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"]]
    })], EditorsRoutingModule);
    var routedComponents = [_editors_component__WEBPACK_IMPORTED_MODULE_3__["EditorsComponent"], _tiny_mce_tiny_mce_component__WEBPACK_IMPORTED_MODULE_4__["TinyMCEComponent"], _ckeditor_ckeditor_component__WEBPACK_IMPORTED_MODULE_5__["CKEditorComponent"]];
    /***/
  },
  ...
  /***/
  function srcAppPagesEditorsEditorsComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var EditorsComponent = function EditorsComponent() {
      _classCallCheck(this, EditorsComponent);
    };

    EditorsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
  ...
  /***/
  function srcAppPagesEditorsEditorsModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "EditorsModule", function () {
    ...
    var ng2_ckeditor__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ng2-ckeditor */
    "./node_modules/ng2-ckeditor/lib/ng2-ckeditor.js");
    /* harmony import */


    var ng2_ckeditor__WEBPACK_IMPORTED_MODULE_3___default =
    /*#__PURE__*/
    __webpack_require__.n(ng2_ckeditor__WEBPACK_IMPORTED_MODULE_3__);
    /* harmony import */
    ...
    var _editors_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./editors-routing.module */
    "./src/app/pages/editors/editors-routing.module.ts");

    var EditorsModule = function EditorsModule() {
      _classCallCheck(this, EditorsModule);
    };

    EditorsModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_nebular_theme__WEBPACK_IMPORTED_MODULE_2__["NbCardModule"], _theme_theme_module__WEBPACK_IMPORTED_MODULE_4__["ThemeModule"], _editors_routing_module__WEBPACK_IMPORTED_MODULE_5__["EditorsRoutingModule"], ng2_ckeditor__WEBPACK_IMPORTED_MODULE_3__["CKEditorModule"]],
      declarations: _toConsumableArray(_editors_routing_module__WEBPACK_IMPORTED_MODULE_5__["routedComponents"])
    })], EditorsModule);
    /***/
  },
  ...
  /***/
  function srcAppPagesEditorsTinyMceTinyMceComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var TinyMCEComponent = function TinyMCEComponent() {
...
//# sourceMappingURL=editors-editors-module-es5.js.map